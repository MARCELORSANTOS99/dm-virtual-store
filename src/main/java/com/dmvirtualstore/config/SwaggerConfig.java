...
public class SwaggerConfig implements WebMvcConfigurer {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.dmvirtualstore.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API DM Virtual Store",
				"Esta API é utilizada na Loja Virtual", "Versão 1.0",
				"https://www.udemy.com/terms",
				new Contact("DM Virutal Store", "udemy.com/user/nelio-alves", "dm-virtual-store@gmail.com"),
				"Permitido aos Devs", "https://dmvirtualstore.com/terms", Collections.emptyList() // Vendor
																										// Extensions
		);
	}
